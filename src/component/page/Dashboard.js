...
function Information({ cName}) {
  return <span className={cName}>Kilala bilang "Queen Pineapple," masigla ang pag-usbong ng Formosa sa Bicol. Dahil dito, naging isa ang Camarines Norte sa mga pangunahing tagapagluwas ng pinya sa Pilipinas. Kinikilala rin ang Formosa bilang pinakamatamis na pinya sa Pilipinas, na may laman ng sukrosa na mas mataas kaysa sa karaniwang itinatanim na mga uri ng pinya sa bansa.</span>
}
  ...
  return (
    <div className='about' id="Tungkol">
      <div className='about-col-one'>
        ...
        <button type="button" class="btn btn-success">Karagdagang impormasyon</button>
      </div>
